...
model HeatExchanger
  ...
  parameter Modelica.Units.SI.PressureDifference dp2Hex_nominal(displayUnit=
    ...
    annotation (Dialog(group="Nominal condition"));
  parameter Modelica.Units.SI.PressureDifference dpVal1Hex_nominal(displayUnit=
        "Pa") = dp1Hex_nominal/2
    "Nominal pressure drop of primary control valve"
    annotation (Dialog(enable=have_val1Hex, group="Nominal condition"));
  parameter Modelica.Units.SI.PressureDifference dpVal2Hex_nominal(displayUnit=
        "Pa") = dp2Hex_nominal/2
