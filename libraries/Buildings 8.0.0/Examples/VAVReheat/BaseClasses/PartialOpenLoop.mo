...
partial model PartialOpenLoop
  ...
  parameter Modelica.Units.SI.Volume VRooCor=flo.VRooCor "Room volume corridor";
  ...
  parameter Modelica.Units.SI.Volume VRooEas=flo.VRooEas "Room volume east";
  parameter Modelica.Units.SI.Volume VRooWes=flo.VRooWes "Room volume west";
  ...
  parameter Modelica.Units.SI.MassFlowRate mCor_flow_nominal=ACHCor*VRooCor*
      conv "Design mass flow rate core";
  parameter Modelica.Units.SI.MassFlowRate mSou_flow_nominal=ACHSou*VRooSou*
      conv "Design mass flow rate south";
  parameter Modelica.Units.SI.MassFlowRate mEas_flow_nominal=ACHEas*VRooEas*
      conv "Design mass flow rate east";
  parameter Modelica.Units.SI.MassFlowRate mNor_flow_nominal=ACHNor*VRooNor*
      conv "Design mass flow rate north";
  parameter Modelica.Units.SI.MassFlowRate mWes_flow_nominal=ACHWes*VRooWes*
      conv "Design mass flow rate west";
  ...
  parameter Modelica.Units.SI.Temperature THotWatInl_nominal(displayUnit="degC")
     = 55 + 273.15 "Reheat coil nominal inlet water temperature";
